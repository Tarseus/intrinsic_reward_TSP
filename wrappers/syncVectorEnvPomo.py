...
class SyncVectorEnv(VectorEnv):
    ...
    def __init__(self, env_fns, observation_space=None, action_space=None, copy=True):
        ...
        self.pomo_size = self.envs[0].pomo_size
        self.gamma = self.envs[0].gamma
        self.problem_size = self.envs[0].problem_size
        ...
        self._rewards = np.zeros((self.num_envs, self.pomo_size), dtype=np.float64)
        self._dones = np.zeros((self.num_envs, self.pomo_size), dtype=np.bool_)
        self._actions = None
